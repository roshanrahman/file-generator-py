...
def get_userinput():
    ...
    if '$' not in name:
        ...
        num = int(raw_input("How many copies do you want: "))
    return name, num
...
if len(sys.argv) == 1:
    ...
    print "Either run the script without arguments, or pass the file name of a text file containing list of files to be created."
    exit(0)
